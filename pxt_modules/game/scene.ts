...
namespace scene {
    ...
    export class Scene {
        ...
        init() {
            ...
            this.eventContext.registerFrameHandler(
                CONTROLLER_SPRITES_PRIORITY,
            ...
            // prerender update 55
            this.eventContext.registerFrameHandler(
                PRE_RENDER_UPDATE_PRIORITY,
                () => {
                    const dt = this.eventContext.deltaTime
                    this.camera.update()

                    for (const s of this.allSprites) s.__update(this.camera, dt)
                },
            )
            ...
            this.eventContext.registerFrameHandler(
                ...
                () => {
                    ...
                    if (game.debug) this.physicsEngine.draw()
