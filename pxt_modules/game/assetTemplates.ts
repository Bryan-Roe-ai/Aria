...
//% helper=getTilemapByName
//% pyConvertToTaggedTemplate
function tilemap8(lits: any, ...args: any[]): tiles.TileMapData {
    return null
}

//% helper=getTilemapByName
//% pyConvertToTaggedTemplate
function tilemap16(lits: any, ...args: any[]): tiles.TileMapData {
    return null
}

//% helper=getTilemapByName
//% pyConvertToTaggedTemplate
function tilemap32(lits: any, ...args: any[]): tiles.TileMapData {
    return null
}

//% helper=getTilemapByName
//% pyConvertToTaggedTemplate
function tilemap4(lits: any, ...args: any[]): tiles.TileMapData {
    return null
}
...
namespace assets {
    ...
    //% pyConvertToTaggedTemplate
    //% blockIdentity="tiles._tilemapEditor"
    export function tilemap(lits: any, ...args: any[]): tiles.TileMapData {
        return null
    }
    ...
    export function image(lits: any, ...args: any[]): Image {
        return null
    }
    ...
    export function tile(lits: any, ...args: any[]): Image {
        return null
    }
    ...
    export function animation(lits: any, ...args: any[]): Image[] {
        return null
    }
    ...
    export function song(lits: any, ...args: any[]): Buffer {
        return null
    }
}
