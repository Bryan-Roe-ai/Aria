namespace effects {
    ...
    export class ParticleEffect {
        ...
        start(
            ...
            const src = this.sourceFactory(
                anchor,
                particlesPerSecond ? particlesPerSecond : this.defaultRate,
            )
        ...
        destroy(
            ...
            this.start(
                ...
                particlesPerSecond,
                null,
                !!(anchor.flags & sprites.Flag.RelativeToCamera),
            )
        ...
        implements BackgroundEffect
    {
        ...
        startScreenEffect(
            ...
            if (this.source && this.source.enabled) {
                if (duration) this.source.lifespan = duration
                return
            }
            ...
            this.source = this.sourceFactory(
                new SceneAnchor(),
                particlesPerSecond ? particlesPerSecond : this.sceneDefaultRate,
            )
    ...
    export function clearParticles(anchor: Sprite | particles.ParticleAnchor) {
        ...
        if (!sources) return
        sources.filter(ps => ps.anchor === anchor).forEach(ps => ps.destroy())
    }
    ...
    export const spray = createEffect(20, 2000, function () {
        return new particles.SprayFactory(100, 0, 120)
    })

    //% fixedInstance whenUsed block="trail"
    export const trail = new ParticleEffect(20, 4000, function (
        anchor: particles.ParticleAnchor,
        particlesPerSecond: number,
    ) {
    ...
    export const fountain = new ParticleEffect(20, 3000, function (
        anchor: particles.ParticleAnchor,
        particlesPerSecond: number,
    ) {
        ...
        const source = new particles.ParticleSource(
            anchor,
            particlesPerSecond,
            factory,
        )
    ...
    export const confetti = new ScreenEffect(10, 40, 4000, function (
        anchor: particles.ParticleAnchor,
        particlesPerSecond: number,
    ) {
        const factory = new particles.ConfettiFactory(
            anchor.width ? anchor.width : 16,
            16,
        )
        factory.setSpeed(30)
        return new particles.ParticleSource(anchor, particlesPerSecond, factory)
    ...
    export const hearts = new ScreenEffect(5, 20, 2000, function (
        anchor: particles.ParticleAnchor,
        particlesPerSecond: number,
    ) {
        const factory = new particles.ShapeFactory(
            anchor.width ? anchor.width : 16,
            16,
            img`
            . F . F .
    ...
    export const smiles = new ScreenEffect(5, 25, 1500, function (
        anchor: particles.ParticleAnchor,
        particlesPerSecond: number,
    ) {
        const factory = new particles.ShapeFactory(
    ...
    export const rings = createEffect(5, 1000, function () {
        return new particles.ShapeFactory(
            16,
            16,
            img`
            . F F F .
    ...
    export const fire = new ParticleEffect(50, 5000, function (
        anchor: particles.ParticleAnchor,
        particlesPerSecond: number,
    ) {
        const factory = new particles.FireFactory(5)
        const src = new particles.FireSource(
            anchor,
            particlesPerSecond,
            factory,
        )
    ...
    export const warmRadial = createEffect(30, 2500, function () {
        return new particles.RadialFactory(0, 30, 10)
    })

    //% fixedInstance whenUsed block="cool radial"
    export const coolRadial = createEffect(30, 2000, function () {
        return new particles.RadialFactory(0, 30, 10, [0x6, 0x7, 0x8, 0x9, 0xa])
    })
    ...
    export const ashes = new ParticleEffect(60, 2000, function (
        anchor: particles.ParticleAnchor,
        particlesPerSecond: number,
    ) {
    ...
    export const disintegrate = new ParticleEffect(60, 1250, function (
        anchor: particles.ParticleAnchor,
        particlesPerSecond: number,
    ) {
    ...
    export const blizzard = new ScreenEffect(15, 50, 3000, function (
        anchor: particles.ParticleAnchor,
        particlesPerSecond: number,
    ) {
        ...
        const factory = new SnowFactory(
            anchor.width ? anchor.width : 16,
            anchor.height ? anchor.height : 16,
        )
        const src = new particles.ParticleSource(
            anchor,
            particlesPerSecond,
    ...
    export const bubbles = new ScreenEffect(15, 40, 5000, function (
        anchor: particles.ParticleAnchor,
        particlesPerSecond: number,
    ) {
        const min = anchor.width > 50 ? 2000 : 500
        const factory = new particles.BubbleFactory(anchor, min, min * 2.5)
        return new particles.BubbleSource(
            anchor,
            particlesPerSecond,
            factory.stateCount - 1,
            factory,
        )
    })

    //% fixedInstance whenUsed block="star field"
    export const starField = new ScreenEffect(2, 5, 5000, function (
        anchor: particles.ParticleAnchor,
        particlesPerSecond: number,
    ) {
    ...
    export const clouds = new ScreenEffect(0.5, 1.5, 5000, function (
        anchor: particles.ParticleAnchor,
        particlesPerSecond: number,
    ) {
    ...
    export const none = new ScreenEffect(0, 0, 0, function (
        anchor: particles.ParticleAnchor,
        particlesPerSecond: number,
    ) {
        class NullParticleSource extends particles.ParticleSource {
            ...
            _prune() {
                ...
                if (sources && sources.length) sources.removeElement(this)
            }
            destroy() {
                this._prune()
            }
