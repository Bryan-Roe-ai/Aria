...
namespace helpers {
    ...
    declare function _drawScaledRotatedImage(
        img: Image,
        src: Image,
        args: number[],
    ): void
    ...
    declare function _checkOverlapsTwoScaledRotatedImages(
        img: Image,
        src: Image,
        args: number[],
    ): boolean
    ...
    function pack(x: number, y: number) {
        return (
            (Math.clamp(-30000, 30000, x | 0) & 0xffff) |
            (Math.clamp(-30000, 30000, y | 0) << 16)
        )
    }

    let _blitArgs: number[]

    export function imageBlit(
        img: Image,
        xDst: number,
        yDst: number,
        wDst: number,
    ...
    export function imageFillCircle(
        img: Image,
        cx: number,
        cy: number,
        r: number,
    ...
    export function imageFillTriangle(
        img: Image,
        x0: number,
        y0: number,
        x1: number,
    ...
    export function imageFillPolygon4(
        img: Image,
        x0: number,
        y0: number,
        x1: number,
    ...
    export function imageDrawScaledRotated(
        dest: Image,
        destX: number,
        destY: number,
        src: Image,
    ...
    export function checkOverlapsScaledRotatedImage(
        dest: Image,
        destX: number,
        destY: number,
        src: Image,
    ...
    export function checkOverlapsTwoScaledRotatedImages(
        dest: Image,
        destX: number,
        destY: number,
        destSx: number,
