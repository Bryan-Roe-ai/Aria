namespace pins {
    ...
    export function i2cWriteNumber(
        address: number,
        value: number,
        format?: NumberFormat,
        repeated?: boolean,
    ): void {
        if (format == undefined) format = NumberFormat.UInt8LE
    ...
    export function i2cWriteRegister(
        address: number,
        register: number,
        value: number,
        valueFormat?: NumberFormat,
    ): void {
        if (valueFormat === undefined) valueFormat = NumberFormat.UInt8LE
    ...
    export function i2cReadRegister(
        address: number,
        register: number,
        valueFormat?: NumberFormat,
    ): number {
     ...
     */
    //%
    export function i2cWriteBuffer(
        address: number,
        buf: Buffer,
        repeat: boolean = false,
    ): number {
