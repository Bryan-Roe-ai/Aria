namespace pins {
    export class LevelDetector {
        ...
        constructor(
            ...
            this.onHigh = () =>
                control.raiseEvent(this.id, DAL.LEVEL_THRESHOLD_HIGH)
            this.onLow = () =>
                control.raiseEvent(this.id, DAL.LEVEL_THRESHOLD_LOW)
        ...
        reset() {
            this.transition = 0
            this.transitionMs = 0
            this._level = Math.ceil(
                (this.highThreshold - this.lowThreshold) / 2,
            )
