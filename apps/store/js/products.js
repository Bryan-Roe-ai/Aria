...
const PRODUCTS = [
    {
        ...
        description:
            "High-quality wireless earbuds with noise cancellation, 24-hour battery life, and premium sound. Perfect for music, calls, and workouts.",
        featured: true,
        features: [
    ...
    },
    {
        ...
        image: "images/placeholder.svg",
        description:
            "Feature-packed smartwatch with health tracking, GPS, and a stunning AMOLED display. Stay connected and monitor your fitness goals.",
        featured: true,
        features: [
            '1.4" AMOLED display',
    ...
    },
    {
        ...
        image: "images/placeholder.svg",
        description:
            "Expand your laptop connectivity with this compact 7-in-1 USB-C hub featuring HDMI, USB 3.0, SD card reader, and power delivery.",
        featured: false,
        features: [
            "4K HDMI output",
    ...
    },
    {
        ...
        image: "images/placeholder.svg",
        description:
            "Compact, waterproof Bluetooth speaker with 360-degree sound and 12-hour playtime. Take your music anywhere.",
        featured: true,
        features: [
