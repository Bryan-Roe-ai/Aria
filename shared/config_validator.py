...
def validate_configs_before_daemon(
    ...
    configs_to_check = [
        ("master_orchestrator", repo_root / "config" /
         "master_orchestrator.yaml" if repo_root else Path("config/master_orchestrator.yaml")),
        ("autonomous_training", repo_root / "config" /
         "autonomous_training.yaml" if repo_root else Path("config/autonomous_training.yaml")),
    ]
...
if __name__ == "__main__":
    ...
    ap = argparse.ArgumentParser(
        description="Validate orchestrator configurations")
    ap.add_argument("--config", help="Config file to validate")
    ap.add_argument("--verbose", "-v", action="store_true",
                    help="Verbose output")
    ap.add_argument("--check-all", action="store_true",
                    help="Check all known configs")
    args = ap.parse_args()
