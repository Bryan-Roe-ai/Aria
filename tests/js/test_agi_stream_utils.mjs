...
const UTILS_PATH = path.resolve(__dirname, '../../apps/chat/static/agi_stream_utils.js');
...
function loadAgiStreamUtils() {
  ...
  assert.ok(context.global.AGIStreamUtils, 'AGIStreamUtils should attach to global');
