...
def main() -> None:
    ...
    if _BLOCK:
        print(
            f"🛑  SECRETS BLOCKED: Detected possible hardcoded secret{secret_hint}{path_hint}. "
        ...
        print(
            f"⚠️  SECRETS WARNING: Possible hardcoded secret detected{secret_hint}{path_hint}. "
