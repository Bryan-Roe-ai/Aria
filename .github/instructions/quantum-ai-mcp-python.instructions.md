...
- Cost gate for Azure QPU: require `confirm_cost=true` (tool args) and set `azure_confirm_cost: true` in `config/quantum/quantum_autorun.yaml` before real hardware.
