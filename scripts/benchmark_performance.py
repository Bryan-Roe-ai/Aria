...
from performance_utils import tail_file, find_json_in_output, stream_jsonl
...
def benchmark_tail_file():
    ...
    print(f"Task: Get last 20 lines\n")
...
def benchmark_json_parsing():
    ...
    print(f"Task: Extract JSON metrics from end\n")
...
def benchmark_jsonl_streaming():
    ...
    print(f"Task: Process records with filtering\n")
