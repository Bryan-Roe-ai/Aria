...
;(function () {
    ...
    var links = [
        ...
        {
            label: "GitHub",
            href: "https://github.com/Bryan-Roe/Aria",
            id: "github",
            external: true,
        },
    ]
    ...
    var navHTML =
        ...
        '<a href="' +
        prefix +
        '" style="display:flex;align-items:center;gap:8px;text-decoration:none;color:#fff;font-weight:700;font-size:1.1em;">' +
        "\uD83D\uDC64 Aria</a>" +
