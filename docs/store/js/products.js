...
const PRODUCTS = [
    {
        ...
        description:
            "Monthly access package for teams that want provider-backed chat, richer character workflows, dashboards, and production-grade runtime features without a custom engagement.",
        featured: true,
        features: [
    ...
    },
    {
        ...
        image: "images/placeholder.svg",
        description:
            "A focused enablement package for teams adopting LoRA fine-tuning, evaluation loops, and autonomous training cycles across the Aria stack.",
        featured: true,
        features: [
    ...
    },
    {
        ...
        image: "images/placeholder.svg",
        description:
            "Hybrid quantum-classical pilot planning for teams exploring simulators, Azure Quantum workflows, and proof-of-value experiments before committing to larger workloads.",
        featured: true,
        features: [
    ...
    },
    {
        ...
        image: "images/placeholder.svg",
        description:
            "Hands-on deployment scoping for organizations packaging Aria for internal rollout, managed infrastructure, and operator onboarding.",
        featured: false,
        features: [
